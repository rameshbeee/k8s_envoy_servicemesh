...
servicec:
	@ kubectl delete configmap sidecar-config-c
...
frontend:
	...
	@ kubectl delete -f ./front_envoy/k8_deployment.yml
	@ kubectl create -f ./front_envoy/k8_deployment.yml

.PHONY: build clean push servicea serviceb servicec frontend
